      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-8 md:py-14">
        ...
        <section className="mt-16 max-w-3xl mx-auto text-center">
          ...
          <p className="text-eve-cream/70 text-base leading-relaxed">
            Tell Eve where in {city.shortName} you are, when you want to start, and how long you want the evening to run. She picks a dinner anchor, a dessert or drink to follow, a walk to bridge the night, and a closer that lands. Each stop is real and verified against Google Search. Booking deep links open OpenTable, Resy, or Tock with the right party size and time pre-filled.
          </p>
          <div className="mt-7 flex justify-center">
            <button
              onClick={onPlanInCity}
